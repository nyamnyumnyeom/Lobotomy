...
/*!
    * @file     PCBangSDKResult.h
    * \korean
    * @brief    PCBangSDK에서 사용하는 Code 값의 헤더 파일입니다
    * \endkorean
    * \english
    * @brief    Header file of Code values used in PCBangSDK
    * \endenglish
*/
...
namespace Stove
{
    namespace PCSDK
    {
        namespace PCBang
        {
            ...
            * @file     PCBangSDKResult.h
            * \korean
            * @brief    PCBangSDK에서 사용하는 함수들의 Code
            * \endkorean
            * \english
            * @brief    Code of functions used in PCBangSDK
            * \endenglish
            */
            enum class SDKMethod : uint32_t
            {
                ...
                */
                ...
                /// 81 : PCBang_UserLogout
                USER_LOGOUT = 81U,

                /// 82 : PCBang_CheckPCBangStatus
                CHECK_PCBANG_STATUS = 82U,

                /// 83 : PCBang_RefreshUserBenefits
            ...
            * @file     PCBangSDKResult.h
            * \korean
            * @brief    PCBangSDK에서 사용하는 함수의 Result Code
            * \endkorean
            * \english
            * @brief    Result Code of functions used in PCBangSDK
            * \endenglish
            */
            ...
            * \endkorean
            * \english
            * @brief    Name of PCBangSDK
            * \endenglish
            */
            static const wchar_t* PCBangSDKName = L"PCBangSDK";
        }
    }
}