...
/*!
    * @file     GameSupportSDKResult.h
    * \korean
    * @brief    GameSupportSDK에서 사용하는 Code값의 헤더 파일입니다.
    * \endkorean
    * \english
    * @brief    Header file of Code values used in GameSupportSDK.
    * \endenglish
*/
...
namespace Stove
{
    namespace PCSDK
    {
        namespace GameSupport
        {
            ...
            * @file     GameSupportSDKResult.h
            * \korean 
            * @brief    GameSupportSDK에서 사용하는 함수들의 Code
            * \endkorean
            * \english
            * @brief    Code of functions used in GameSupportSDK
            * \endenglish
            */
            enum class SDKMethod : uint32_t
            {
                ...
                * Common Method
                */
                /// 1 : GameSupport_Initialize
                INITIALIZE = 1U,

                /// 2 : GameSupport_UnInitialize
                UNINITIALIZE = 2U,
                ...
                /// 5 : GameSupport_GetVersion
                GET_VERSION = 5U,

                /*
                * GameSupportSDK Method
                */
                /// 80 : GameSupport_Stat
                STAT = 80U,

                /// 81 : GameSupport_ModifyStat
                MODIFY_STAT = 81U,

                /// 82 : GameSupport_Achievement
                ACHIEVEMENT = 82U,

                /// 83 : GameSupport_AllAchievement
                ALL_ACHIEVEMENT = 83U,
            ...
            * @file     GameSupportSDKResult.h
            * \korean
            * @brief    GameSupportSDK에서 사용하는 함수의 Result Code
            * \endkorean
            * \english
            * @brief    Result Code of functions used in GameSupportSDK
            * \endenglish
            */
            ...
            * @file     GameSupportSDKResult.h
            * \korean
            * @brief    GameSupportSDK의 이름
            * \endkorean
            * \english
            * @brief    Name of GameSupportSDK
            * \endenglish
            */
            static const wchar_t* GameSupportSDKName = L"GameSupportSDK";
        }
    }
}