...
void ALB_GM::PlayerDeathLogic(FVector TargetLocation, int32 Num)
{
	...
	case 4:
		LB_Character->PlayDeathSequence_Doctor(TargetLocation);
		break;
...
void ALB_GM::UpdateDate()
{
	...
	case 2:
		if (UGameInstance* GameInstance = GetGameInstance())
		{
			...
			if (AchievementSub)
			{
				...
				AchievementSub->UnlockAchievement(FName("DAY2_ACHIEVEMENT"));
			}
		}
		break;
	...
	case 3:
		if (UGameInstance* GameInstance = GetGameInstance())
		{
			...
			{
				// 스팀웍스 대시보드에 등록된 API 이름을 인자로 전달합니다.
				AchievementSub->UnlockAchievement(FName("DAY3_ACHIEVEMENT"));
			}
		}
		break;
	...
	case 4:
		if (UGameInstance* GameInstance = GetGameInstance())
		{
			...
			{
				// 스팀웍스 대시보드에 등록된 API 이름을 인자로 전달합니다.
				AchievementSub->UnlockAchievement(FName("DAY4_ACHIEVEMENT"));
			}
		}
		break;
	...
	case 5:
		if (UGameInstance* GameInstance = GetGameInstance())
		{
			...
			{
				// 스팀웍스 대시보드에 등록된 API 이름을 인자로 전달합니다.
				AchievementSub->UnlockAchievement(FName("DAY5_ACHIEVEMENT"));
			}
		}
		break;
	...
	case 6:
		if (UGameInstance* GameInstance = GetGameInstance())
		{
			...
			{
				// 스팀웍스 대시보드에 등록된 API 이름을 인자로 전달합니다.
				AchievementSub->UnlockAchievement(FName("DAY6_ACHIEVEMENT"));
			}
		}
		break;
	...
	case 7:
		if (UGameInstance* GameInstance = GetGameInstance())
		{
			...
			{
				// 스팀웍스 대시보드에 등록된 API 이름을 인자로 전달합니다.
				AchievementSub->UnlockAchievement(FName("DAY7_ACHIEVEMENT"));
			}
		}
		break;
