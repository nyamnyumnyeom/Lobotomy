...
void ULB_SettingUI::NativeConstruct()
{
    ...
    if (ComboResolution)
    {
        ...
        else ComboResolution->SetSelectedOption("1080p");
    }
    ...
    ComboAA->OnSelectionChanged.AddDynamic(this, &ULB_SettingUI::OnAAChanged);
    ComboPost->OnSelectionChanged.AddDynamic(this, &ULB_SettingUI::OnPostChanged);
    ComboShadow->OnSelectionChanged.AddDynamic(this, &ULB_SettingUI::OnShadowChanged);
